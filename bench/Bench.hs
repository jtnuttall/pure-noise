...
benchPerlin2 seed octaves sz =
  [ bgroup
      ...
      , benchMany2 @Float "ridged" sz seed (ridgedMulti2 defaultFractalConfig{octaves} perlin2)
      , benchMany2 @Double "ridged" sz seed (ridgedMulti2 defaultFractalConfig{octaves} perlin2)
...
benchOpenSimplex2 seed octaves sz =
  [ bgroup
      ...
      , benchMany2 @Float "ridged" sz seed (ridgedMulti2 defaultFractalConfig{octaves} openSimplex2)
      , benchMany2 @Double "ridged" sz seed (ridgedMulti2 defaultFractalConfig{octaves} openSimplex2)
...
benchOpenSimplexSmooth2 seed octaves sz =
  [ bgroup
      ...
      , benchMany2 @Float "ridged" sz seed (ridgedMulti2 defaultFractalConfig{octaves} superSimplex2)
      , benchMany2 @Double "ridged" sz seed (ridgedMulti2 defaultFractalConfig{octaves} superSimplex2)
...
benchValue2 seed octaves sz =
  [ bgroup
      ...
      , benchMany2 @Float "ridged" sz seed (ridgedMulti2 defaultFractalConfig{octaves} value2)
      , benchMany2 @Double "ridged" sz seed (ridgedMulti2 defaultFractalConfig{octaves} value2)
...
benchValueCubic2 seed octaves sz =
  [ bgroup
      ...
      , benchMany2 @Float "ridged" sz seed (ridgedMulti2 defaultFractalConfig{octaves} valueCubic2)
      , benchMany2 @Double "ridged" sz seed (ridgedMulti2 defaultFractalConfig{octaves} valueCubic2)
...
benchPerlin3 seed octaves sz =
  [ bgroup
      ...
      , benchMany3 @Float "ridged" sz seed (ridgedMulti3 defaultFractalConfig{octaves} perlin3)
      , benchMany3 @Double "ridged" sz seed (ridgedMulti3 defaultFractalConfig{octaves} perlin3)
...
benchValue3 seed octaves sz =
  [ bgroup
      ...
      , benchMany3 @Float "ridged" sz seed (ridgedMulti3 defaultFractalConfig{octaves} value3)
      , benchMany3 @Double "ridged" sz seed (ridgedMulti3 defaultFractalConfig{octaves} value3)
...
benchValueCubic3 seed octaves sz =
  [ bgroup
      ...
      , benchMany3 @Float "ridged" sz seed (ridgedMulti3 defaultFractalConfig{octaves} valueCubic3)
      , benchMany3 @Double "ridged" sz seed (ridgedMulti3 defaultFractalConfig{octaves} valueCubic3)
